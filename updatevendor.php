...
if(isset($_POST['submit'])){
    ...
    QRcode :: png($qrCodeData, $qrcode, 'H', 4, 4);
            ...
            $updatequery = "UPDATE food_vendor SET vendor_id = '$userID', vendor_name = '$username', vendor_email = '$email', vendor_phonenum = '$phonenum', vendor_address = '$address', vendor_qrcode = '$qrimage' WHERE vendor_id = '$pid2'";
